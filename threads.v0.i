...
# 10 "common_threads.h"
   "rc == 0"
# 10 "common_threads.h" 3 4
   , "common_threads.h", 10, __extension__ __PRETTY_FUNCTION__); }))
# 10 "common_threads.h"
                  ;
}
...
# 15 "common_threads.h"
   "rc == 0"
# 15 "common_threads.h" 3 4
   , "common_threads.h", 15, __extension__ __PRETTY_FUNCTION__); }))
# 15 "common_threads.h"
                  ;
}
...
# 20 "common_threads.h"
   "rc == 0"
# 20 "common_threads.h" 3 4
   , "common_threads.h", 20, __extension__ __PRETTY_FUNCTION__); }))
# 20 "common_threads.h"
                  ;
}
...
# 25 "common_threads.h"
   "rc == 0"
# 25 "common_threads.h" 3 4
   , "common_threads.h", 25, __extension__ __PRETTY_FUNCTION__); }))
# 25 "common_threads.h"
                  ;
}
...
# 30 "common_threads.h"
   "rc == 0"
# 30 "common_threads.h" 3 4
   , "common_threads.h", 30, __extension__ __PRETTY_FUNCTION__); }))
# 30 "common_threads.h"
                  ;
}
# 4 "threads.v0.c" 2
