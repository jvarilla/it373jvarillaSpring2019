...
# 11 "common.h"
   "rc == 0"
# 11 "common.h" 3 4
   , "common.h", 11, __extension__ __PRETTY_FUNCTION__); }))
# 11 "common.h"
                  ;
...
# 24 "common.h"
   "rc == 0"
# 24 "common.h" 3 4
   , "common.h", 24, __extension__ __PRETTY_FUNCTION__); }))
# 24 "common.h"
                  ;
}
...
# 29 "common.h"
   "rc == 0"
# 29 "common.h" 3 4
   , "common.h", 29, __extension__ __PRETTY_FUNCTION__); }))
# 29 "common.h"
                  ;
}
...
# 34 "common.h"
   "rc == 0"
# 34 "common.h" 3 4
   , "common.h", 34, __extension__ __PRETTY_FUNCTION__); }))
# 34 "common.h"
                  ;
}
...
# 39 "common.h"
   "rc == 0"
# 39 "common.h" 3 4
   , "common.h", 39, __extension__ __PRETTY_FUNCTION__); }))
# 39 "common.h"
                  ;
}
...
# 44 "common.h"
   "rc == 0"
# 44 "common.h" 3 4
   , "common.h", 44, __extension__ __PRETTY_FUNCTION__); }))
# 44 "common.h"
                  ;
}
# 6 "mem.c" 2
...
# 16 "mem.c"
   "p != NULL"
# 16 "mem.c" 3 4
   , "mem.c", 16, __extension__ __PRETTY_FUNCTION__); }))
# 16 "mem.c"
                    ;
